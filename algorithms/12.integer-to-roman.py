...
class Solution:
    def intToRoman(self, num: int) -> str:
        # Pythonic greedy approach with value-symbol pairs
        ...
        # One-liner using reduce (functional):
        # from functools import reduce; vals, syms = zip(*[(1000, "M"), (900, "CM"), (500, "D"), (400, "CD"), (100, "C"), (90, "XC"), (50, "L"), (40, "XL"), (10, "X"), (9, "IX"), (5, "V"), (4, "IV"), (1, "I")]); return reduce(lambda acc, item: acc[0] + item[1] * (item[2] // item[0]), [(v, s, num := num if True else None) for v, s in zip(vals, syms)], "")
        
        # Cleaner one-liner with list comprehension:
        # mapping = [(1000, "M"), (900, "CM"), (500, "D"), (400, "CD"), (100, "C"), (90, "XC"), (50, "L"), (40, "XL"), (10, "X"), (9, "IX"), (5, "V"), (4, "IV"), (1, "I")]; num_ref = [num]; return "".join(sym * (num_ref[0] // val) if not (num_ref := [num_ref[0] % val]) else sym * (num_ref[0] // val) for val, sym in mapping)
# @lc code=end
